    ...
    <main className="min-h-screen px-4 py-6 sm:px-6 sm:py-10 lg:px-10 lg:py-12">
      <div className="mx-auto grid max-w-3xl gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(24rem,28rem)] lg:items-center">
        <section className="max-w-md">
          ...
          <h1 className="mt-4 font-[family:var(--font-display)] text-5xl leading-none tracking-[-0.05em] text-stone-950 dark:text-stone-50 sm:text-6xl">
          ...
          <p className="mt-6 text-sm text-stone-500 dark:text-stone-400">
            {mode === "signin" ? (
              <>
                No account?{" "}
                <Link href="/signup" className="text-stone-950 underline underline-offset-4 dark:text-stone-50">
                  Sign up
                </Link>
              </>
            ) : (
              <>
                Have an account?{" "}
                <Link href="/signin" className="text-stone-950 underline underline-offset-4 dark:text-stone-50">
                  Sign in
                </Link>
              </>
            )}
